...
function Strategy(options, verify) {
  ...
  options.authorizationURL =
    options.authorizationURL ||
    'https://identity.endpass.com/api/v1.1/oauth/auth';
  options.tokenURL =
    options.tokenURL || 'https://identity.endpass.com/api/v1.1/oauth/token';
  ...
  this._userProfileURL =
    options.userProfileURL || 'https://api.endpass.com/v1/user';
